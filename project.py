...
def get_weather():
    try:
        ...
        # Weather:
        api_key = "529e2d0b1312a576a5205c0a703c76cc"
...
search_image_label = tk.Label(root, image=search_image, border=0) 
search_image_label.pack(pady=20, side=tk.TOP)


text_field = tk.Entry(root, justify="center", width=17, font=("poppins", 25, "bold"), bg="#404040", fg="white", border=0)  
text_field.place(x = 280, y = 40)


search_icon = tk.PhotoImage(file="search_icon.png")
search_icon_buttun = tk.Button(root, image=search_icon,border=0, cursor="hand2", command = get_weather, bg="#404040")
search_icon_buttun.place(x = 590, y=32)
...
label2.place(x=450, y=400)

label2 = tk.Label(root,text="PRESSURE", font=("Helvetica", 15, "bold"),fg="white", bg="#1ab5ef")
label2.place(x=670, y=400)
...
wind_label= tk.Label(root,text="...", font=("arial", 20, "bold"),fg="#4b4bcc",bg="#1ab5ef")
wind_label.place(x=120, y=430)

humidity_label= tk.Label(root,text="...", font=("arial", 20, "bold"),fg="#4b4bcc",bg="#1ab5ef")
humidity_label.place(x=280, y=430)

description_label= tk.Label(root,text="...", font=("arial", 20, "bold"),fg="#4b4bcc",bg="#1ab5ef")
description_label.place(x=450, y=430)

pressure_label= tk.Label(root,text="...", font=("arial", 20, "bold"),fg="#4b4bcc",bg="#1ab5ef")
